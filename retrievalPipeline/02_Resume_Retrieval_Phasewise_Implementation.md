...
>
> **Codebase rule:** Do not create a new project or a second server. Add retrieval to the **same Node.js + TypeScript + Express codebase** and reuse the same MongoDB database, `resume_collection` collection, environment configuration, middleware, logging, and Mistral embedding integration.
